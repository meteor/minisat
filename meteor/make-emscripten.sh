...
$EMCC -g -O3 --memory-init-file 0 --pre-js ../../../meteor/preamble.js --post-js ../../../meteor/postamble.js -s EXPORTED_FUNCTIONS='["_yo", "_unyo", "_createTheSolver", "_addClause", "_solve"]' -s TOTAL_MEMORY=67108864 -s NO_BROWSER=1 -s NO_FILESYSTEM=1 -s NO_DYNAMIC_EXECUTION=0 minisat.bc -o minisat.js
popd
